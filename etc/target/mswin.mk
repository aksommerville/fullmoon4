...
mswin_ICON_DST:=$(mswin_OUTDIR)/icon.ico
mswin-all:$(mswin_EXE) $(mswin_DATA_FULL) $(mswin_DATA_DEMO) $(mswin_ICON_DST)
...
mswin_ICON_SRC:=src/opt/mswin/icon.ico
$(mswin_ICON_DST):$(mswin_ICON_SRC);$(PRECMD mswin) cp $< $@
...
mswin-run-full:$(mswin_EXE) $(mswin_DATA_FULL) $(mswin_ICON_DST);$(mswin_EXE) --data=$(mswin_DATA_FULL) $(mswin_RUN_ARGS)
mswin-run-demo:$(mswin_EXE) $(mswin_DATA_DEMO) $(mswin_ICON_DST);$(mswin_EXE) --data=$(mswin_DATA_DEMO) $(mswin_RUN_ARGS)
mswin-run:mswin-run-full

mswin-verify:$(tools_EXE_datan) $(mswin_DATA_FULL) $(mswin_DATA_DEMO) $(mswin_ICON_DST); \
  $(tools_EXE_datan) --src=src/data --archive=$(mswin_DATA_FULL) --archive=$(mswin_DATA_DEMO)
